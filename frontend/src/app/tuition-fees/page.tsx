...
async function loadCoursesWithFeesSafe() {
  try {
    ...
    return { ok: true as const, coursesWithFees };
  } catch (e) {
    console.error("TUITION_FEES_PRISMA_ERROR:", e);
    return { ok: false as const, coursesWithFees: [] };
  }
}

export default async function TuitionFeesPage() {
  const { ok, coursesWithFees } = await loadCoursesWithFeesSafe();
          ...
          <section className="hidden lg:block">
            <div className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm">
              ...
              <p className="mt-3 text-sm leading-6 text-gray-700">
                We keep tuition clear and supportive — with flexible options
                available, so you can focus on learning and progression.
              </p>
              ...
              <div className="mt-6 grid gap-4">
                <div className="rounded-2xl border border-gray-200 bg-white p-5">
                  ...
                  <p className="mt-2 text-sm text-gray-700">
                    Spread tuition across manageable instalments. We’ll agree an
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-5">
                  ...
                  <p className="mt-2 text-sm text-gray-700">
                    Prefer to pay once and move on? Pay in full (where
                    available) and receive a 10% discount. If you’re unsure what
                    suits you best, we can help you choose an option that works.
                  </p>
                  <Link
                    href="/enquiry"
                    className="mt-3 inline-flex text-sm font-semibold text-[color:var(--color-brand)] hover:underline"
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-5">
                  ...
                  <p className="mt-2 text-sm text-gray-700">
                    If you’re eligible, scholarship support may be available to
                    reduce your tuition fee.
                  </p>
                  <Link
                    href="/scholarships"
                    className="mt-3 inline-flex text-sm font-semibold text-[color:var(--color-brand)] hover:underline"
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-5">
                  ...
                  <p className="mt-2 text-sm text-gray-700">
                    Learning support, materials guidance, and tutor support —
                    plus guidance on university progression and final-year
                    admission for eligible students (where applicable).
                  </p>
                  <Link
                    href="/courses"
                    className="mt-3 inline-flex text-sm font-semibold text-[color:var(--color-brand)] hover:underline"
                ...
                <div className="rounded-2xl border border-red-100 bg-[color:var(--color-brand-soft)] p-5">
                  ...
                  <p className="mt-2 text-sm text-gray-700">
                    Progress is rarely about finding the perfect time — it’s
                    about taking the next sensible step. If you’re ready to
                    learn, we’ll help you choose a tuition option that works.
                  </p>
                  <Link
                    href="/enquiry"
                    className="mt-3 inline-flex text-sm font-semibold text-[color:var(--color-brand)] hover:underline"
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm">
              <div className="mb-5">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Fees are listed by course level. For tailored payment options,
                  please{" "}
                  <Link
                    href="/enquiry"
              ...
              {/* ✅ NEW: Safe fallback if DB is unavailable during build/runtime */}
              {!ok ? (
                <div className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
                  <p className="font-semibold">Fees are temporarily unavailable.</p>
                  <p className="mt-1">
                    Please refresh in a moment. If this continues, send an enquiry and we’ll help.
                  </p>
                  <div className="mt-3">
                    <Link
                      href="/enquiry"
                      className="inline-flex text-sm font-semibold text-[color:var(--color-brand)] hover:underline"
                    >
                      Send an enquiry
                    </Link>
                  </div>
                ...
                {grouped.map((g) => (
                  <div key={g.key}>
                    ...
                    {ok && g.items.length === 0 ? (
                      ...
                      <div className="mt-3 rounded-2xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-700">
                        We’ll show fees here once they’re available.
                      </div>
                    ) : (
